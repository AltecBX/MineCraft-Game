...
function startGame() {
  ...
  editsByDim.overworld = new Map(); editsByDim.fire = new Map(); editsByDim.end = new Map(); editsByDim.sky = new Map(); editsByDim.realm = new Map(); editsByDim.mario = new Map(); marioQ = { coinsGot: 0, toad: false, stomps: 0, dk: false, bowser: false, hidden: false }; chestStore = new Map(); openChestK = null; day = 1; timeOfDay = 0.28;
